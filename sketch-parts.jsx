...
function SiteHeader({ active = "landing", compact = false }) {
  return (
    <div className="sk-row" style={{
      ...
      <div className="sk-row sk-gap-10" style={{ alignItems: "baseline" }}>
        <div style={{
        ...
        <div className="sk-hand" style={{ fontSize: 14, color: "var(--ink-3)" }}>
          pulsar timing tutorial
        </div>
      </div>
      <div className="sk-nav">
        <span className={"item" + (active === "landing" ? " active" : "")}>Tutorial</span>
        <span className={"item" + (active === "play" ? " active" : "")}>Try it</span>
        <span className={"item" + (active === "ref" ? " active" : "")}>Reference</span>
        <span className="sk-chip" style={{ marginLeft: 8 }}>
