...
function InteractiveV2() {
  ...
  return (
    <div className="sk-page" style={{ width: V2_IPG_W, height: V2_IPG_H, overflow: "hidden", background: "#0d1714" }}>
      {/* ---------- title bar ---------- */}
      <div className="sk-row" style={{ background: "#0a100d", color: "#cfe3d7", height: 38, alignItems: "center", paddingLeft: 14, gap: 18, borderBottom: "1px solid #1b2c25" }}>
        <span style={{ fontFamily: "var(--font-display)", fontSize: 14, fontWeight: 600, color: "#9fd3b9", letterSpacing: 0.4 }}>✦ PSRCHIVE</span>
        <div className="sk-row" style={{ gap: 22, fontFamily: "var(--font-display)", fontSize: 13, fontWeight: 500 }}>
          <span style={{ color: "#7c9c8d" }}>Tutorial</span>
          <span style={{ color: "#d5ecdd", borderBottom: "2px solid #4dbb91", paddingBottom: 8 }}>Try it</span>
          <span style={{ color: "#7c9c8d" }}>Reference</span>
        </div>
        <span style={{ marginLeft: "auto", marginRight: 14, fontFamily: "var(--font-mono)", fontSize: 11, color: "#7c9c8d" }}>workspace · 2 archives loaded</span>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "260px 1fr 300px", height: V2_IPG_H - 38 - 32 }}>
